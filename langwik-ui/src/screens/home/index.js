...
class Home extends PureComponent {
  ...
  async onGetData() {
    ...
    Client.getOverview().then((response) => {
      this.setState({
    ...
    return (
      <View style={styles.container}>
        ...
        >
          ...
          {user?.token && dataOverview && dataOverview.length > 0 && (
            <View style={styles.overview}>
              ...
              >
                <ProgressCircle
                  widthX={77}
                  progress={
                    Math.round(dataOverview[0].course_data?.result?.result) /
                    100
                  }
                  strokeWidth={8}
                ...
                <View style={{ marginLeft: 24 }}>
                      ...
                      <View style={styles.line}>
                        <View
                          style={[
                            ...
                            {
                              width: `${
                                (dataOverview[0].course_data?.result?.items
                                  ?.lesson?.completed /
                                  dataOverview[0].course_data?.result?.items
                                    ?.lesson?.total) *
                                100
                  ...
                  {dataOverview[0].course_data?.result?.items?.assignment
                    ?.total > 0 && (
                    <View style={styles.viewItem}>
                      <Image
              ...
              >
                ...
                <Text style={styles.txt1}>
                  {dataOverview[0]?.sections.length}{' '}
                  {dataOverview[0]?.sections.length > 1
